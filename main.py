...
# Pre-calculate health response to avoid redundant dictionary creation and Pydantic overhead
cached_health_response = {
    "status": "healthy",
...
async def health_check():
    """Health check endpoint - Optimized to return cached dictionary"""
