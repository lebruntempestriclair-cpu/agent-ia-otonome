...
class Settings:
    ...
    def __init__(self):
        ...
        # Security check: ensure default API key is not used in production
        if (self.REQUIRE_API_KEY and
            self.DEPLOYMENT_ENV == "production" and
            self.API_KEY == "default_secret_key"):
            raise ValueError("SECURITY ERROR: Default API key cannot be used in production environment.")
