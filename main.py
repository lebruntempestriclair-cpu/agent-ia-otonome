...
class Settings:
    """Application settings and configuration cached from environment variables"""
    def __init__(self):
...
# Instantiate settings once to avoid repeated os.getenv calls
settings = Settings()
...
async def health_check():
    ...
    # Optimized: Returning a raw dictionary to bypass Pydantic validation/serialization overhead
    # while maintaining OpenAPI documentation via the 'responses' parameter.
    return {
        "status": "healthy",
        "version": "1.0.0",
